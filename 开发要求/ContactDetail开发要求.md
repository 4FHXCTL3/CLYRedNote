...
```json
{
  ...
  "ContactTab": [
    "ContactDetail"//now todo!
  ],
}
```

## 参考截图
UIReference/ContactDetail.jpg


## 你当前的任务
设计ContactDetail页面，该页面的要素包括:

1. 顶部：左侧返回箭头按钮（点击可返回），右侧三点
2. 中间显示头像，名字，ID，Region

3. 中间的列表要素注意不一样的间距

4. moments旁显示朋友圈动态的缩略图，channels旁显示发布视频号的缩略图

5. 要求从ContactTab点击相应联系人可以进入该联系人的详情界面