...
## 可参考的截图
UIReference/Cart.jpg


## 你当前的任务
设计Cart页面，该页面的要素包括:
1. 顶部：左侧返回按钮，右侧搜索和管理按钮，下面小字分类，参考截图。
2. 中间购物车商品列表，每条包含店名、商品缩略图、商品名称、款式选择下拉列表、价格、数量。列表支持向下滑动，请设计超过一面的信息内容，可以下滑查看。商品图用assets里的
3. 最底部有全选按钮，总计可以计算选中的商品的总金额，结算按钮
4. 尽可能与参考截图一致