...
## 可参考的截图
UIReference/CommentAtTab.jpg


## 你当前的任务
设计CommentAtTab页面，该页面的要素包括:
1. 页面上方是标题“收到的评论和@”居中；接着是多条评论记录，每条记录包含评论者头像、名称、回复时间、评论内容，原笔记的小图片，每条评论下方有“赞”和“回复”按钮；最下方有“-THE END-”的提示。
2. 该界面的进入位置是“消息->评论和@“
3. 尽可能与参考截图一致