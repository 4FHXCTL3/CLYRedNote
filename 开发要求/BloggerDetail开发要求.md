...
"MainActivity":[
    ...
    "MeTab":[
    	...
    	"FolllowingTab":[
            "BloggerDetail"//NowToDo!!
        ]
}
```

## 可参考的截图
UIReference/BloggerDetail.jpg


## 你当前的任务
设计BloggerDetail页面，该页面的要素包括:
1. 页面上方是带有账号头像、名称、小红书号、IP属地的个人信息区域，还有一段宣传语和几个标签；接着是展示关注数、粉丝数、获赞与收藏数的区域，旁边有“关注”和“私信”按钮，还有“群聊”和“评价”板块；再往下是“笔记”区域，有搜索框和两个分类入口，下面是多条笔记内容，每条笔记包含图片和文字信息等。
2. 该界面的进入位置是“我->关注->点击关注列表某个博主”
3. 尽可能与参考截图一致