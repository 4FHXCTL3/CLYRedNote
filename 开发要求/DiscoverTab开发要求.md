...
## 可参考的截图
UIReference/DiscoverTab.jpg


## 你当前的任务
设计DiscoverTab页面，该页面的要素包括:
1. 顶部信息栏：文字居中，搜索按钮、“＋”按钮
2. 界面整体分为顶部信息栏、中间分类列表、底部三个块。顶部是标题和功能图标区域；中间是各类功能分类栏；底部是导航栏。

3. 注意各板块之间的间距是不一样的

4. 点击底部菜单栏的Discover可以跳转到本DiscoverTab页面