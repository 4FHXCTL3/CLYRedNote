...
"MainActivity":[
    ...
    "PostTab":[
    	...
    	"SearchTab":[
    		...
    		"BloggerDetail":[
                "MessageDetail"//NowToDo!!
            ]
}
```

## 可参考的截图
UIReference/MessageDetail.jpg


## 你当前的任务
设计MessageDetail页面，该页面的要素包括:
1. 页面上方是聊天对象的名称和头像，右侧有更多操作的三点按钮；接着是聊天记录区域，展示了双方发送的文字、图片等消息；再往下是表情推荐栏，显示了几个常用表情；最底部是消息输入区域，包含发消息的输入框，左侧有语音输入按钮，右侧有表情按钮和加号功能按钮。
2. 该界面的进入路线“MeTab->关注->BloggerDetail->私信”
3. 尽可能与参考截图一致