...
## 可参考的截图
UIReference/MarketTab.jpg


## 你当前的任务
设计MarketTab页面，该页面的要素包括:
1. 顶部导航栏：搜索框，点击可以弹出键盘进行文字输入。下面一排小字是分类以及带图标的分类。
3. 中间是各个商品的缩略图和信息，一行两个。每个笔记简介包括封面图、标题、售价、销量。请设计超过一面的商品内容，可以下滑查看。
