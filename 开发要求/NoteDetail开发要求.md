...
1. 顶部：左侧作者头像和名称，右侧关注按钮和转发按钮，参考截图。
2. 中间发表的图片，图片有多张时支持左右滑动查看，图像下面是文案，文案下面是时间和IP。

3. 接下来下面是评论区列表，可以发表评论，查看他人评论，他人评论如截图，包括头像、名称、内容、时间、IP。请设计超过一面的信息内容，可以下滑查看。

4. 这是一个长截图，可以向下滑动，尽可能与参考截图一致