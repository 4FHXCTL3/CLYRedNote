...
"MainActivity":[
    ...
    "PostTab":[
    	...
    	"Settings":[
            "AccountSecurity"//NowToDo!!
        ]
    
    		"BloggerDetail":[
                "MessageDetail"//finished
            ]
}
```

## 可参考的截图
UIReference/AccountSecurity.jpg


## 你当前的任务
设计AccountSecurity.页面，该页面的要素包括:
1. 页面上方是居中标题“账号与安全”，左侧有返回箭头；接着是一系列账号安全相关的选项，每个选项包含名称和对应的状态（如手机号、登录密码、微信账号、微博账号、QQ账号、实名认证、官方认证、登录设备管理、账号授权管理、账号找回、专业号等），每个选项右侧有箭头可进入详细设置页面，这些选项按顺序依次排列。
2. 该界面的进入路线“MeTab->Settings->点击账号与安全”
3. 尽可能与参考截图一致