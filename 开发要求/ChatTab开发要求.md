...
## 可参考的截图
UIReference/ChatTab.jpg


## 你当前的任务
设计ChatTab页面，该页面的要素包括:
1. 顶部信息栏：搜索按钮、“＋”按钮
2. 聊天列表：每个聊天包含4个要素
    2.1：好友头像（或者群头像）
    2.2：好友名或群聊名
    2.3：最近发言内容，若是好友聊天则直接显示聊天信息，若是群聊且发言人不是我，则显示"发言人：信息"，否则依然直接显示聊天信息
    2.4 最近发言时间（直接简化成MM.DD HH:MM即可，不必显示成“昨天”、“早晨”等相对时间）

3. 点击底部菜单栏的chats可以跳转到本ChatTab页面，点击me可跳转到MeTab页面