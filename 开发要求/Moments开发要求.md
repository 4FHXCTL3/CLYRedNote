...
## 可参考的截图
UIReference/Moments.jpg


## 你当前的任务
设计Moments页面，该页面的要素包括:

1. 上面彩色的是背景图，可以更换，当下面朋友圈内容上滑时会覆盖掉背景图
2. 背景图和朋友圈内容的分界线上是自己的头像和昵称
    
3. 下半部分朋友圈内容每个联系人的每一次发表隔开，开头显示联系人头像和昵称，显示文字和图片内容，下面有发表时间。点击发表时间右侧三点弹出心形点赞形状，如图UIReference/Moments_1.jpg所示，点击图案下面会出现点赞图标和点赞人的昵称，设计有些朋友的发表有多个点赞人用逗号隔开

4. 要求从DiscoverTab点击Moments可以进入该Moments界面