...
## 可参考的截图
UIReference/FolllowingTab.jpg


## 你当前的任务
设计FolllowingTab页面，该页面的要素包括:
1. 页面上方是“互相关注”“关注”“粉丝”“推荐”的标签栏；接着是搜索已关注的人的搜索框；再往下是“我的关注”区域，显示关注数量，旁边有“综合排序”选项，还有“全部”“商家”的分类标签；下面是关注列表，每条关注项包含头像、名称、简介（部分有未看笔记提示）、“已关注”按钮和更多操作的三点按钮。
2. 该界面的进入位置是“我->关注”点击进入
3. 尽可能与参考截图一致